...
export default function Sidebar() {
    return (
        <ul className="menu bg-base-200 rounded-box">
            ...
            <li>
                <a className="tooltip tooltip-right" data-tip="Movies">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6 hover:text-primary-color">
            ...
            <li>
                <a className="tooltip tooltip-right" data-tip="Series">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6 hover:text-primary-color">
            ...
            <li>
                <a className="tooltip tooltip-right" data-tip="Favourites">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6 hover:text-primary-color">
