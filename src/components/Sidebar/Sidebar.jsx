...
export default function Sidebar() {
    return (
        <ul className="menu bg-base-200 shadow-lg fixed flex h-full flex-col z-10 my-14">
            <li>
                <Link to="/Home" className="tooltip tooltip-right my-6" data-tip="Home">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6 hover:text-primary-color">
            ...
            <li>
                <Link to="/movies" className="tooltip tooltip-right my-6" data-tip="Movies">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6 hover:text-primary-color">
            ...
            <li>
                <Link to="/series" className="tooltip tooltip-right my-6" data-tip="Series">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6 hover:text-primary-color">
            ...
            <li>
                <Link to="/favourites" className="tooltip tooltip-right my-6" data-tip="Favourites">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6 hover:text-primary-color">
            ...
            <li>
                <Link to="/admin/createMovie" className="tooltip tooltip-right my-6" data-tip="Created">
