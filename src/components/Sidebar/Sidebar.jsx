...
export default function Sidebar() {
    return (
        <ul className="menu bg-base-200 shadow-lg fixed flex h-full flex-col z-10 my-14">
            <li>
                <Link to="/Home">
                    <a className="tooltip tooltip-right my-6" data-tip="Home">
            ...
            <li>
                <Link to="/movies">
                    <a className="tooltip tooltip-right my-6" data-tip="Movies">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6 hover:text-primary-color">
            ...
            <li>
                <Link to="/series">
                    <a className="tooltip tooltip-right my-6" data-tip="Series">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6 hover:text-primary-color">
            ...
            <li>
                <Link to="/favourites">
                    <a className="tooltip tooltip-right my-6" data-tip="Favourites">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6 hover:text-primary-color">
